...
public:
    ...
    void Interpolate(std::unordered_map<UUIDv4::UUID, std::shared_ptr<chroma::shared::core::GameObject>>& new_snapshot, uint64_t delta_time);
    void Update(uint64_t delta_time);

    void SetGameObjects(const std::shared_ptr<std::unordered_map<UUIDv4::UUID, std::shared_ptr<chroma::shared::core::GameObject>>>& objects);
...
private:
    ...
    std::unordered_map<UUIDv4::UUID, std::shared_ptr<chroma::shared::core::GameObject>> target_game_objects_;
