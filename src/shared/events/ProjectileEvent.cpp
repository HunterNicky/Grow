...
ProjectileEvent::ProjectileEvent(const core::component::TypeProjectile type, const Vector2 &direction,
  const float speed)
  : Event(Type::ProjectileEvent), projectile_type_(type), direction_(direction), speed_(speed)
{}

ProjectileEvent::ProjectileEvent() : Event(Type::ProjectileEvent) {}

core::component::TypeProjectile ProjectileEvent::GetProjectileType() const { return projectile_type_; }

ProjectileEvent::Type ProjectileEvent::GetStaticType() { return Type::ProjectileEvent; }
