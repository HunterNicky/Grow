...
ProjectileMessage::ProjectileMessage(uint32_t sequence, float delta_time)
...
const std::shared_ptr<event::ProjectileEvent> &ProjectileMessage::GetProjectileEvent() const { return projectile_event_; }
