  ...
  namespace chroma::shared::packet::adapter
{
  ...
  void ComponentAdapter::ComponentToRun(
    const Game::Component *component, const std::shared_ptr<core::GameObject> &game_object)
  {
  ...
  void ComponentAdapter::ComponentToTransform(
    const Game::Component *component, const std::shared_ptr<core::GameObject> &game_object)
  {
  ...
  void ComponentAdapter::ComponentToSpeed(
    const Game::Component *component, const std::shared_ptr<core::GameObject> &game_object)
  {
  ...
  void ComponentAdapter::ComponentToMovement(
    const Game::Component *component, const std::shared_ptr<core::GameObject> &game_object)
  {
  ...
  void ComponentAdapter::ComponentToColor(
    const Game::Component *component, const std::shared_ptr<core::GameObject> &game_object)
  {
  ...
  void ComponentAdapter::ComponentToHealth(
    const Game::Component *component, const std::shared_ptr<core::GameObject> &game_object)
  {
  ...
  void ComponentAdapter::ComponentToInventory(
    const Game::Component *component, const std::shared_ptr<core::GameObject> &game_object)
  {
  ...
  void ComponentAdapter::ComponentToItem(
    const Game::Item *item, const std::shared_ptr<core::component::Inventory> &inventory)
  {
  ...
  void ComponentAdapter::ComponentToAttack(
    const Game::Component *component, const std::shared_ptr<core::GameObject> &game_object)
  {
  ...
  void ComponentAdapter::ComponentToProjectileType(
    const Game::Component *component, const std::shared_ptr<core::GameObject> &game_object)
  {
    ...
    std::vector<flatbuffers::Offset<Game::Component>> &fb_components)
  {
    ...
    const auto fb_component =
      Game::CreateComponent(builder, Game::ComponentUnion::ProjectileType, fb_proj_type.Union());
    fb_components.push_back(fb_component);
  }
