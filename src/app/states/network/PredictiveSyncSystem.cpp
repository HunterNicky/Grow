...
void PredictiveSyncSystem::ClearInputEventHistory()
{
    input_event_history_.clear();
}

uint32_t PredictiveSyncSystem::GetLastProcessedInputSeq() const
{
    return last_processed_input_seq_;
}

void PredictiveSyncSystem::SetLastProcessedInputSeq(uint32_t seq)
{
    last_processed_input_seq_ = seq;
}
