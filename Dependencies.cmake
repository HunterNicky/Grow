...
function(chroma_setup_dependencies)
  ...
  if (NOT raygui_FOUND)
    ...
    if (NOT TARGET raygui)
      ...
      if (MSVC)
        target_compile_options(raygui INTERFACE /W4)
  ...
  if (NOT TARGET uuid_v4_silenced)
    ...
    if (MSVC)
      target_compile_options(uuid_v4_silenced INTERFACE /W4 /arch:AVX2)
    elseif (CMAKE_CXX_COMPILER_ID MATCHES "Clang" OR CMAKE_CXX_COMPILER_ID MATCHES "GNU")
  ...
  if (NOT TARGET nlohmann_json_silenced)
    ...
    if (MSVC)
      target_compile_options(nlohmann_json_silenced INTERFACE /W4)
    elseif (CMAKE_CXX_COMPILER_ID MATCHES "Clang" OR CMAKE_CXX_COMPILER_ID MATCHES "GNU")
  ...
  if (NOT TARGET fastnoiselite_silenced)
    ...
    if (MSVC)
      target_compile_options(fastnoiselite_silenced INTERFACE /W4)
    elseif (CMAKE_CXX_COMPILER_ID MATCHES "Clang" OR CMAKE_CXX_COMPILER_ID MATCHES "GNU")
  ...
  if (NOT TARGET aitoolkit_silenced)
    ...
    if (MSVC)
      target_compile_options(aitoolkit_silenced INTERFACE /W4)
    elseif (CMAKE_CXX_COMPILER_ID MATCHES "Clang" OR CMAKE_CXX_COMPILER_ID MATCHES "GNU")
